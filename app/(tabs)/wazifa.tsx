...
const WAZIFA_DHIKR = {
  ...
  salatFatih: {
    ...
    transliteration: 'Allāhumma ṣalli ʿalā sayyidinā Muḥammadin l-fātiḥi limā ughliqa...',
  ...
  jawhara: {
    ...
    arabic: 'اَللَّهُـمَّ صَـلِّ وَسَلِّـمْ عَـلَى عَيْـنِ الـرَّحْـمَـةِ الرَّبَّــانِـيَـةِ',
    transliteration: 'Allāhumma ṣalli wa sallim ʿalā ʿayni r-raḥmati r-rabbāniyyati...',
    translation: 'O Allah, bestow blessings and peace upon the Essence of Divine Mercy...',
  },
} as const;
